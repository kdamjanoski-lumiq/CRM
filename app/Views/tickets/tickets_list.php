...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var ticketCompactView = appCompactView.init({
            ...
            dataSourceUrl: "<?php echo get_uri('tickets/view/' . $ticket_id); ?>",
        ...
        if (isMobile()) {
            $(document).on("click", "#ticket-table .box-label", function() {
                $(".tickets-list-section").addClass("hide");
                $(".navbar").addClass("hide");
                $(".navbar-custom").addClass("hide");
                $("#compact-details-page").removeClass("hide");
            });
        };
    });
</script>