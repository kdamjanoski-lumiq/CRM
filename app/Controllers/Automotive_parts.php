...
class Automotive_parts extends Security_Controller {
    ...
    function sales() {
        ...
        return $this->template->rander("automotive/parts/sales");
    }
    ...
    function view($id = 0) {
        ...
        if ($id) {
            ...
            if ($part_info) {
                ...
                return $this->template->view('automotive/parts/view', $view_data);
            } else {
                show_404();
            }
        } else {
    ...
    function sale_modal_form() {
        ...
        return $this->template->view('automotive/parts/sale_modal_form', $view_data);
    }
    ...
    function view_sale($id = 0) {
        ...
        if ($id) {
            ...
            if ($sale_info) {
                ...
                return $this->template->view('automotive/parts/view_sale', $view_data);
            } else {
                show_404();
            }
        } else {
